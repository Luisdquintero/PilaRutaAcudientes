...
class GeofenceTrasitionService2 extends IntentService {

    private static final String TAG = GeofenceTrasitionService.class.getSimpleName();
    public static final int GEOFENCE_NOTIFICATION_ID = 0;

    public GeofenceTrasitionService2() {
        super(TAG);
    }
...
//        Intent notificationIntent = UbicacionActualActivity.makeNotificationIntent(
//                getApplicationContext(), msg
//        );
//
//        TaskStackBuilder stackBuilder = TaskStackBuilder.create(this);
//        stackBuilder.addParentStack(UbicacionActualActivity.class);
